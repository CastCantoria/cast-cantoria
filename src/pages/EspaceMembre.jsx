...
const EspaceMembre = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      audio.play();
      setRituelMessage(`Faly miarahaba anao, ${user.displayName || 'Mpanjohy'} 🎶`);
    } catch (error) {
      console.error(error);
      setRituelMessage("Échec de la connexion Google.");
    }
  };
  ...
  const handleFacebookLogin = async () => {
    try {
      ...
      audio.play();
      setRituelMessage(`Tongasoa, ${user.displayName || 'Mpanjohy'} 🙌`);
    } catch (error) {
      console.error(error);
      setRituelMessage("Échec de la connexion Facebook.");
    }
  };
